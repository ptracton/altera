...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/testing_mm_interconnect_0_rsp_xbar_mux.sv"       -work rsp_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/testing_mm_interconnect_0_rsp_xbar_demux.sv"     -work rsp_xbar_demux                                                          
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work cmd_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/testing_mm_interconnect_0_cmd_xbar_mux.sv"       -work cmd_xbar_mux                                                            
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/testing_mm_interconnect_0_cmd_xbar_demux_001.sv" -work cmd_xbar_demux_001                                                      
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/testing_mm_interconnect_0_cmd_xbar_demux.sv"     -work cmd_xbar_demux                                                          
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/testing_mm_interconnect_0_id_router.sv"          -work id_router                                                               
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/testing_mm_interconnect_0_addr_router.sv"        -work addr_router                                                             
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/testing_irq_mapper.sv"                           -work irq_mapper                                                              
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_mm_interconnect_0.v"                     -work mm_interconnect_0                                                       
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_jtag_uart_0.v"                           -work jtag_uart_0                                                             
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_SWITCHES.v"                              -work SWITCHES                                                                
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_LEDS.v"                                  -work LEDS                                                                    
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_MEMORY.v"                                -work MEMORY                                                                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_CPU_jtag_debug_module_sysclk.v"          -work CPU                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_CPU_test_bench.v"                        -work CPU                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_CPU_oci_test_bench.v"                    -work CPU                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_CPU_mult_cell.v"                         -work CPU                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_CPU_jtag_debug_module_wrapper.v"         -work CPU                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_CPU.vo"                                  -work CPU                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/testing_CPU_jtag_debug_module_tck.v"             -work CPU                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/testing.v"                                                                                                                                
fi

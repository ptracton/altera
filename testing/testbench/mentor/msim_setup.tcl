...
alias com {
  echo "\[exec\] com"
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/verbosity_pkg.sv"                                                             -work altera_common_sv_packages                                               
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_merlin_arbitrator.sv"                     -L altera_common_sv_packages -work rsp_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/testing_mm_interconnect_0_rsp_xbar_mux.sv"       -L altera_common_sv_packages -work rsp_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/testing_mm_interconnect_0_rsp_xbar_demux.sv"     -L altera_common_sv_packages -work rsp_xbar_demux                                                          
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_merlin_arbitrator.sv"                     -L altera_common_sv_packages -work cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/testing_mm_interconnect_0_cmd_xbar_mux.sv"       -L altera_common_sv_packages -work cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/testing_mm_interconnect_0_cmd_xbar_demux_001.sv" -L altera_common_sv_packages -work cmd_xbar_demux_001                                                      
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/testing_mm_interconnect_0_cmd_xbar_demux.sv"     -L altera_common_sv_packages -work cmd_xbar_demux                                                          
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_merlin_traffic_limiter.sv"                -L altera_common_sv_packages -work limiter                                                                 
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_merlin_reorder_memory.sv"                 -L altera_common_sv_packages -work limiter                                                                 
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_avalon_sc_fifo.v"                         -L altera_common_sv_packages -work limiter                                                                 
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_avalon_st_pipeline_base.v"                -L altera_common_sv_packages -work limiter                                                                 
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/testing_mm_interconnect_0_id_router.sv"          -L altera_common_sv_packages -work id_router                                                               
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/testing_mm_interconnect_0_addr_router.sv"        -L altera_common_sv_packages -work addr_router                                                             
  ...
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_merlin_slave_agent.sv"                    -L altera_common_sv_packages -work CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_merlin_burst_uncompressor.sv"             -L altera_common_sv_packages -work CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_merlin_master_agent.sv"                   -L altera_common_sv_packages -work CPU_instruction_master_translator_avalon_universal_master_0_agent       
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_merlin_slave_translator.sv"               -L altera_common_sv_packages -work CPU_jtag_debug_module_translator                                        
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_merlin_master_translator.sv"              -L altera_common_sv_packages -work CPU_instruction_master_translator                                       
  ...
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/testing_irq_mapper.sv"                           -L altera_common_sv_packages -work irq_mapper                                                              
  ...
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_conduit_bfm_0002.sv"                      -L altera_common_sv_packages -work testing_inst_switches_input_bfm                                         
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_conduit_bfm.sv"                           -L altera_common_sv_packages -work testing_inst_leds_output_bfm                                            
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_avalon_reset_source.sv"                   -L altera_common_sv_packages -work testing_inst_reset_bfm                                                  
  vlog -sv "$QSYS_SIMDIR/testing_tb/simulation/submodules/altera_avalon_clock_source.sv"                   -L altera_common_sv_packages -work testing_inst_clk_bfm                                                    
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L rsp_xbar_mux -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L limiter -L id_router -L addr_router -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L CPU_jtag_debug_module_translator -L CPU_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L jtag_uart_0 -L SWITCHES -L LEDS -L MEMORY -L CPU -L testing_inst_switches_input_bfm -L testing_inst_leds_output_bfm -L testing_inst_reset_bfm -L testing_inst_clk_bfm -L testing_inst -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}

...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "interrupt_example"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_MEMORY.hex ./
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_CPU_rf_ram_b.mif ./
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_CPU_rf_ram_a.mif ./
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_CPU_rf_ram_b.dat ./
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_CPU_ociram_default_contents.hex ./
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_CPU_rf_ram_a.dat ./
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_CPU_ociram_default_contents.mif ./
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_CPU_ociram_default_contents.dat ./
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_CPU_rf_ram_a.hex ./
  file copy -force $QSYS_SIMDIR/submodules/interrupt_example_CPU_rf_ram_b.hex ./
}
...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_mux_001.sv"   -work rsp_xbar_mux_001                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                               -work rsp_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_mux.sv"       -work rsp_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_demux_003.sv" -work rsp_xbar_demux_003                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_demux.sv"     -work rsp_xbar_demux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                               -work cmd_xbar_mux_003                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_mux_003.sv"   -work cmd_xbar_mux_003                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                               -work cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_mux.sv"       -work cmd_xbar_mux                                                            
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_demux_001.sv" -work cmd_xbar_demux_001                                                      
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_demux.sv"     -work cmd_xbar_demux                                                          
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_id_router_003.sv"      -work id_router_003                                                           
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_id_router.sv"          -work id_router                                                               
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_addr_router_001.sv"    -work addr_router_001                                                         
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_addr_router.sv"        -work addr_router                                                             
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_irq_mapper.sv"                           -work irq_mapper                                                              
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0.v"                     -work mm_interconnect_0                                                       
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_SWITCHES.v"                              -work SWITCHES                                                                
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_LEDS.v"                                  -work LEDS                                                                    
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_JTAG_UART.v"                             -work JTAG_UART                                                               
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_MEMORY.v"                                -work MEMORY                                                                  
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU.v"                                   -work CPU                                                                     
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_jtag_debug_module_sysclk.v"          -work CPU                                                                     
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_oci_test_bench.v"                    -work CPU                                                                     
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_jtag_debug_module_tck.v"             -work CPU                                                                     
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_jtag_debug_module_wrapper.v"         -work CPU                                                                     
  vlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_test_bench.v"                        -work CPU                                                                     
  vlog     "$QSYS_SIMDIR/interrupt_example.v"                                                                                                                                
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_003 -L rsp_xbar_demux -L cmd_xbar_mux_003 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L id_router_003 -L id_router -L addr_router_001 -L addr_router -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L CPU_jtag_debug_module_translator -L CPU_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L SWITCHES -L LEDS -L JTAG_UART -L MEMORY -L CPU -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_003 -L rsp_xbar_demux -L cmd_xbar_mux_003 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L id_router_003 -L id_router -L addr_router_001 -L addr_router -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L CPU_jtag_debug_module_translator -L CPU_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L SWITCHES -L LEDS -L JTAG_UART -L MEMORY -L CPU -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}

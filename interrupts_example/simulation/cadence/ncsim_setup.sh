...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_mux_001.sv"   -work rsp_xbar_mux_001                                                         -cdslib ./cds_libs/rsp_xbar_mux_001.cds.lib                                                        
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                               -work rsp_xbar_mux                                                             -cdslib ./cds_libs/rsp_xbar_mux.cds.lib                                                            
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_mux.sv"       -work rsp_xbar_mux                                                             -cdslib ./cds_libs/rsp_xbar_mux.cds.lib                                                            
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_demux_003.sv" -work rsp_xbar_demux_003                                                       -cdslib ./cds_libs/rsp_xbar_demux_003.cds.lib                                                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_demux.sv"     -work rsp_xbar_demux                                                           -cdslib ./cds_libs/rsp_xbar_demux.cds.lib                                                          
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_mux_003.sv"   -work cmd_xbar_mux_003                                                         -cdslib ./cds_libs/cmd_xbar_mux_003.cds.lib                                                        
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                               -work cmd_xbar_mux                                                             -cdslib ./cds_libs/cmd_xbar_mux.cds.lib                                                            
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_mux.sv"       -work cmd_xbar_mux                                                             -cdslib ./cds_libs/cmd_xbar_mux.cds.lib                                                            
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_demux_001.sv" -work cmd_xbar_demux_001                                                       -cdslib ./cds_libs/cmd_xbar_demux_001.cds.lib                                                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_demux.sv"     -work cmd_xbar_demux                                                           -cdslib ./cds_libs/cmd_xbar_demux.cds.lib                                                          
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_id_router_003.sv"      -work id_router_003                                                            -cdslib ./cds_libs/id_router_003.cds.lib                                                           
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_id_router.sv"          -work id_router                                                                -cdslib ./cds_libs/id_router.cds.lib                                                               
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_addr_router_001.sv"    -work addr_router_001                                                          -cdslib ./cds_libs/addr_router_001.cds.lib                                                         
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_addr_router.sv"        -work addr_router                                                              -cdslib ./cds_libs/addr_router.cds.lib                                                             
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/interrupt_example_irq_mapper.sv"                           -work irq_mapper                                                               -cdslib ./cds_libs/irq_mapper.cds.lib                                                              
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0.v"                     -work mm_interconnect_0                                                        -cdslib ./cds_libs/mm_interconnect_0.cds.lib                                                       
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_SWITCHES.v"                              -work SWITCHES                                                                 -cdslib ./cds_libs/SWITCHES.cds.lib                                                                
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_LEDS.v"                                  -work LEDS                                                                     -cdslib ./cds_libs/LEDS.cds.lib                                                                    
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_JTAG_UART.v"                             -work JTAG_UART                                                                -cdslib ./cds_libs/JTAG_UART.cds.lib                                                               
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_MEMORY.v"                                -work MEMORY                                                                   -cdslib ./cds_libs/MEMORY.cds.lib                                                                  
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU.v"                                   -work CPU                                                                      -cdslib ./cds_libs/CPU.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_jtag_debug_module_sysclk.v"          -work CPU                                                                      -cdslib ./cds_libs/CPU.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_oci_test_bench.v"                    -work CPU                                                                      -cdslib ./cds_libs/CPU.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_jtag_debug_module_tck.v"             -work CPU                                                                      -cdslib ./cds_libs/CPU.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_jtag_debug_module_wrapper.v"         -work CPU                                                                      -cdslib ./cds_libs/CPU.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/interrupt_example_CPU_test_bench.v"                        -work CPU                                                                      -cdslib ./cds_libs/CPU.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/interrupt_example.v"                                                                                                                                                                                                                                    
fi

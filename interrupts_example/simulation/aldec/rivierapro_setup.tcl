...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_mux_001.sv"   -work rsp_xbar_mux_001                                                        
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                               -work rsp_xbar_mux                                                            
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_mux.sv"       -work rsp_xbar_mux                                                            
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_demux_003.sv" -work rsp_xbar_demux_003                                                      
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_rsp_xbar_demux.sv"     -work rsp_xbar_demux                                                          
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                               -work cmd_xbar_mux_003                                                        
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_mux_003.sv"   -work cmd_xbar_mux_003                                                        
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                               -work cmd_xbar_mux                                                            
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_mux.sv"       -work cmd_xbar_mux                                                            
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_demux_001.sv" -work cmd_xbar_demux_001                                                      
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_cmd_xbar_demux.sv"     -work cmd_xbar_demux                                                          
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_id_router_003.sv"      -work id_router_003                                                           
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_id_router.sv"          -work id_router                                                               
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_addr_router_001.sv"    -work addr_router_001                                                         
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_mm_interconnect_0_addr_router.sv"        -work addr_router                                                             
  ...
  vlog  "$QSYS_SIMDIR/submodules/interrupt_example_irq_mapper.sv"                           -work irq_mapper                                                              
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_003 -L rsp_xbar_demux -L cmd_xbar_mux_003 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L id_router_003 -L id_router -L addr_router_001 -L addr_router -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L CPU_jtag_debug_module_translator_avalon_universal_slave_0_agent -L CPU_instruction_master_translator_avalon_universal_master_0_agent -L CPU_jtag_debug_module_translator -L CPU_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L SWITCHES -L LEDS -L JTAG_UART -L MEMORY -L CPU -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}

add wave -noupdate -divider {interrupt_example_CPU: top-level ports}
...
add wave -noupdate -divider {interrupt_example_CPU: common}
...
add wave -noupdate -divider {interrupt_example_CPU: breaks}
